...
mixin _$WeatherResponse {
  ...
  List<WeatherWeatherResponse> get weather =>
...
abstract class $WeatherResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<WeatherWeatherResponse> weather,
      String name});
    ...
    return _then(_value.copyWith(
      ...
      weather: null == weather
          ...
          : weather // ignore: cast_nullable_to_non_nullable
              as List<WeatherWeatherResponse>,
      name: null == name
          ? _value.name
...
class _$WeatherResponseImpl implements _WeatherResponse {
  const _$WeatherResponseImpl(
      {required this.main,
      required final List<WeatherWeatherResponse> weather,
      required this.name})
      : _weather = weather;
  ...
  final List<WeatherWeatherResponse> _weather;
  @override
  List<WeatherWeatherResponse> get weather {
  ...
  @override
  String toString() {
    return 'WeatherResponse(main: $main, weather: $weather, name: $name)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, main, const DeepCollectionEquality().hash(_weather), name);
...
abstract class _WeatherResponse implements WeatherResponse {
  const factory _WeatherResponse(
      ...
      required final List<WeatherWeatherResponse> weather,
      required final String name}) = _$WeatherResponseImpl;
